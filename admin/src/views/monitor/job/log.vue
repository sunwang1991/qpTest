<template>
  <div class="app-container">
    ...
    >
      ...
      <el-form-item label="执行状态" prop="statusFlag">
        <el-select
    ...
    >
      ...
      <el-table-column
        ...
        :show-overflow-tooltip="true"
      />
      <el-table-column label="执行状态" align="left" prop="statusFlag">
        <template #default="scope">
          <dict-tag
    ...
    <el-dialog title="调度日志详细" v-model="open" width="700px" append-to-body>
      <el-form :model="form" label-width="100px">
        <el-row>
          <el-col :span="12">
            <el-form-item label="日志序号：">{{ form.logId }}</el-form-item>
