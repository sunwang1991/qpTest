<template>
  <div class="app-container">
    ...
    >
      ...
      <el-form-item label="任务状态" prop="statusFlag">
        <el-select
    ...
    >
      ...
      />
      <el-table-column label="任务组名" align="left" prop="jobGroup">
      ...
      <el-table-column label="记录日志" align="left" prop="saveLog">
        <template #default="scope">
          <dict-tag :options="sys_job_save_log" :value="scope.row.saveLog" />
        </template>
      </el-table-column>
      <el-table-column
        label="操作"
        ...
        <el-row>
          ...
          <el-col :span="12">
            <el-form-item label="cron表达式" prop="cronExpression">
              <crontab v-model="form.cronExpression" />
            </el-form-item>
          </el-col>
          <el-col :span="12">
            <el-form-item label="记录日志">
              <el-radio-group v-model="form.saveLog">
                <el-radio
                  v-for="dict in sys_job_save_log"
                  :key="dict.value"
                  :value="dict.value"
                >
                  {{ dict.label }}
          ...
          <el-col :span="24">
            <el-form-item label="传入参数" prop="targetParams">
              <el-input
                v-model="form.targetParams"
                type="textarea"
                placeholder="请输入传入参数 JSON格式"
              ></el-input>
            </el-form-item>
          </el-col>
          <el-col :span="24">
          ...
          <el-col :span="24">
            <el-form-item label="出错策略" prop="misfirePolicy">
              <el-radio-group v-model="form.misfirePolicy" :disabled="true">
          ...
          <el-col :span="12">
            <el-form-item label="是否并发" prop="concurrent">
              <el-radio-group v-model="form.concurrent" :disabled="true">
        ...
        <el-row>
          ...
          <el-col :span="12">
            <el-form-item label="任务状态：">
              <dict-tag :options="sys_job_status" :value="form.statusFlag" />
            </el-form-item>
          </el-col>
          <el-col :span="12">
            <el-form-item label="记录日志：">
              <dict-tag :options="sys_job_save_log" :value="form.saveLog" />
            </el-form-item>
          </el-col>
          <el-col :span="24">
...
const { sys_job_group, sys_job_status, sys_job_save_log } = proxy.useDict(
  'sys_job_group',
  'sys_job_status',
  'sys_job_save_log'
);
...
function handleStatusChange(row) {
  ...
  proxy.$modal
    ...
    .then(function () {
      return changeJobStatus(row.jobId, row.statusFlag);
    })
    .then(() => {
