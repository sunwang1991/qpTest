  ...
  <div class="app-container">
    ...
    >
      ...
      <el-table-column
        ...
        width="60"
      ></el-table-column>
      <el-table-column prop="icon" label="菜单图标" align="left" width="100">
      ...
      <el-table-column
        ...
        :show-overflow-tooltip="true"
      ></el-table-column>
      <el-table-column prop="visibleFlag" label="显示状态" width="80">
        <template #default="scope">
          <dict-tag :options="sys_show_hide" :value="scope.row.visibleFlag" />
        </template>
      </el-table-column>
      <el-table-column prop="statusFlag" label="菜单状态" width="80">
        <template #default="scope">
          <dict-tag
    ...
    <el-dialog :title="title" v-model="open" width="680px" append-to-body>
      <el-form ref="menuRef" :model="form" :rules="rules" label-width="100px">
        <el-row>
          ...
          <el-col :span="24">
            <el-form-item label="菜单类型" prop="menuType">
              <el-radio-group v-model="form.menuType">
                ...
                <el-radio :value="MENU_TYPE_MENU">菜单</el-radio>
                <el-radio :value="MENU_TYPE_AUTH">按钮</el-radio>
              </el-radio-group>
            </el-form-item>
          </el-col>
          <el-col :span="24" v-if="form.menuType != MENU_TYPE_AUTH">
          ...
          <el-col :span="12" v-if="form.menuType != MENU_TYPE_AUTH">
            <el-form-item>
              <template #label>
                <span>
                  <el-tooltip
          ...
          <el-col :span="12" v-if="form.menuType == MENU_TYPE_MENU">
          ...
          <el-col :span="12" v-if="form.menuType != MENU_TYPE_DIR">
            <el-form-item>
              <el-input
                v-model="form.perms"
                placeholder="请输入权限标识"
              ...
              <template #label>
                <span>
                  <el-tooltip
                    content="控制器中定义的权限字符，如：monitor:server:query"
                    placement="top"
                  >
                    <el-icon><question-filled /></el-icon>
                  </el-tooltip>
