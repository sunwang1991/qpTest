<template>
	<view class="container">
		...
		<view class="game-records-container">
			<!-- 加载状态 -->
			<view v-if="loading && gameRecords.length === 0" class="loading-container">
				<text class="loading-text">加载中...</text>
			</view>

			<!-- 空状态 -->
			<view v-else-if="!loading && gameRecords.length === 0" class="empty-container">
			...
			<view v-else class="records-list">
				<view v-for="item in gameRecords" :key="item.id" class="record-item">
					...
					<view class="room-info">
						<view class="room-header">
							...
							<text class="status" :class="item.statusFlag === '1' ? 'active' : 'finished'">
								{{ item.statusText }}
							</text>
						</view>
						...
						<view class="room-meta">
							...
							<text class="total-amount">总交易: {{ item.totalTransactionAmount }}</text>
						</view>
					</view>
					...
					<view class="members-income">
						...
						<view class="members-list">
							<view v-for="member in item.membersIncome" :key="member.userId" class="member-item">
								...
								<view class="income-info">
									<text class="net-amount" :class="member.netAmount >= 0 ? 'win' : 'lose'">
				...
				<view v-if="!pagination.hasNext && gameRecords.length > 0" class="no-more">
					<text>没有更多记录了</text>
				</view>
			</view>
		</view>
